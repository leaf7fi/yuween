...
// ignore_for_file: must_be_immutable
class SubscripitionUiOrangeBottomsheet extends StatelessWidget {
            ...
            child: Column(
                ...
                children: [
                  ...
                  Align(
                      ...
                      child: Padding(
                          padding: getPadding(left: 117, top: 11),
                          child: Row(
                  ...
                  Padding(
                      padding: getPadding(left: 5, top: 20),
                      child: Text("Enter the 4-digit code:",
                          overflow: TextOverflow.ellipsis,
                          textAlign: TextAlign.left,
                          style: AppStyle.txtInterMedium16Gray900
                              .copyWith(height: getVerticalSize(1.00)))),
                  ...
                  CustomButton(
                      ...
                      width: 320,
                      text: "Apply",
                      margin: getMargin(left: 5, top: 28, bottom: 10))
                ])));
  }
